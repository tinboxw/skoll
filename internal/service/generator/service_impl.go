...
func buildCandidates(spec domaingenerator.GeneratorSpec, migrationTimestamp string) []fileCandidate {
	...
	if spec.Plugin.Enabled {
		...
		candidates = append(candidates,
			...
			candidate("plugin.frontend.i18n-support", pluginRoot+"/web/src/i18n/index.ts", spec),
			candidate("plugin.frontend.permission-support", pluginRoot+"/web/src/permissions/button.ts", spec),
			candidate("plugin.frontend.ui-support", pluginRoot+"/web/src/components/Common/index.ts", spec),
