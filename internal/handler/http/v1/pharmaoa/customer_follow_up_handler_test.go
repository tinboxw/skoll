...
func TestCustomerFollowUpHTTPRejectsScopeAndActorSpoofing(t *testing.T) {
	...
	list := followUpHTTPRequest(mux, http.MethodGet, "/v1/pharma-oa/customer-follow-ups?includeAll=true&ownerId=sales-2", "", "sales-1")
	...
	create := followUpHTTPRequest(mux, http.MethodPost, "/v1/pharma-oa/customer-follow-ups", body, "sales-1")
