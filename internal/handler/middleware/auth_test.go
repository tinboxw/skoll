...
func TestAuthMiddleware(t *testing.T) {
	...
	reqBearerInvalid := httptest.NewRequest(http.MethodGet, "/api/v1/users", nil)
	...
	reqBearer := httptest.NewRequest(http.MethodGet, "/api/v1/users", nil)
	...
	reqExpired := httptest.NewRequest(http.MethodGet, "/api/v1/users", nil)
	...
	reqWrongSecret := httptest.NewRequest(http.MethodGet, "/api/v1/users", nil)
	...
	req3 := httptest.NewRequest(http.MethodGet, "/api/v1/plugins?enabled=true", nil)
	...
	req4 := httptest.NewRequest(http.MethodPost, "/api/v1/plugins/demo/enable", nil)
	...
	req5 := httptest.NewRequest(http.MethodPost, "/api/v1/auth/login", nil)
