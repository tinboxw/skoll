...
func TestAuthMiddleware(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/skoll/v1/users", nil)
	...
	reqBearer := httptest.NewRequest(http.MethodGet, "/skoll/v1/users", nil)
	...
	reqExpired := httptest.NewRequest(http.MethodGet, "/skoll/v1/users", nil)
	...
	reqWrongSecret := httptest.NewRequest(http.MethodGet, "/skoll/v1/users", nil)
	...
	req2 := httptest.NewRequest(http.MethodGet, "/skoll/health", nil)
	...
	req4 := httptest.NewRequest(http.MethodPost, "/skoll/v1/plugins/demo/enable", nil)
	...
	req5 := httptest.NewRequest(http.MethodPost, "/skoll/v1/auth/login", nil)
