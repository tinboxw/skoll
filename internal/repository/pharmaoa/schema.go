...
var schemaBaseline = []TableSpec{
	...
	table("pharma_oa_customers", "master.customer", []string{"code", "name", "region", "status", "disable_reason", "rating", "owner_id", "organization_id", "contacts_json", "qualifications_json"}, []IndexSpec{index("uk_pharma_customers_code", true, "code"), index("idx_pharma_customers_scope_status", false, "organization_id", "owner_id", "status"), index("idx_pharma_customers_org_status_code", false, "organization_id", "status", "code"), index("idx_pharma_customers_owner_status_code", false, "owner_id", "status", "code"), index("idx_pharma_customers_name", false, "name")}, "master"),
	...
	table("pharma_oa_announcements", "collaboration.announcement", []string{"kind", "title", "content", "status", "published_by", "published_at", "audience_json", "documents_json"}, []IndexSpec{index("idx_pharma_announcements_status_published", false, "status", "published_at")}, "collaboration"),
	...
	immutableTable("pharma_oa_cold_chain_records", "compliance.cold_chain", []string{"balance_id", "product_id", "batch_id", "batch_no", "warehouse_id", "area_id", "location_id", "temperature_celsius", "humidity_percent", "min_celsius", "max_celsius", "recorded_at", "source", "payload_json"}, []IndexSpec{index("idx_pharma_cold_chain_batch_time", false, "batch_id", "recorded_at"), index("idx_pharma_cold_chain_warehouse_time", false, "warehouse_id", "recorded_at")}, "compliance"),
