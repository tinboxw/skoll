...
const _sfc_main = defineComponent({
  ...
  setup(__props) {
    ...
    const overviewStats = computed(() => {
      var _a;
      return ((_a = latestOverview.value) == null ? void 0 : _a.stats) && latestOverview.value.stats.length > 0 ? latestOverview.value.stats : fallbackStats;
    });
    const focusAreas = computed(() => {
      var _a;
      return ((_a = latestOverview.value) == null ? void 0 : _a.focusAreas) && latestOverview.value.focusAreas.length > 0 ? latestOverview.value.focusAreas : fallbackFocus;
    });
    ...
    async function loadOverview() {
      ...
      try {
        const payload = await requestJSON("/demo-separated/overview?plugin_id=demo");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", _hoisted_1, [
        createBaseVNode("header", { class: "hero" }, [
          _cache[0] || (_cache[0] = createBaseVNode("p", { class: "eyebrow" }, "Separated Architecture Demo", -1)),
          _cache[1] || (_cache[1] = createBaseVNode("h1", null, "Aurora Forge Child Application", -1)),
          _cache[2] || (_cache[2] = createBaseVNode("p", null, " This demo represents a realistic child-app homepage: company narrative, backend-powered stats, and recommendation workflows served from separated plugin frontend artifacts. ", -1)),
        ...
        createBaseVNode("section", _hoisted_2, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(overviewStats.value, (item) => {
            return openBlock(), createElementBlock("article", {
              ...
              createBaseVNode("p", null, toDisplayString(item.change), 1)
            ]);
          }), 128))
        ]),
        createBaseVNode("section", _hoisted_3, [
          createBaseVNode("article", _hoisted_4, [
            _cache[3] || (_cache[3] = createBaseVNode("h2", null, "Focus Areas", -1)),
            createBaseVNode("ul", _hoisted_5, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(focusAreas.value, (item) => {
                return openBlock(), createElementBlock("li", {
                  key: item.title
                }, [
                  createBaseVNode("strong", null, toDisplayString(item.title), 1),
                  createBaseVNode("p", null, toDisplayString(item.summary), 1),
                  createBaseVNode("small", null, toDisplayString(item.region) + " \xB7 " + toDisplayString(item.stage), 1)
                ]);
              }), 128))
            ])
          ]),
          createBaseVNode("article", _hoisted_6, [
            _cache[4] || (_cache[4] = createBaseVNode("h2", null, "Output", -1)),
            createBaseVNode("pre", null, toDisplayString(output.value), 1)
          ])
        ])
      ]);
    };
...
var App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1fc4e8be"]]);
