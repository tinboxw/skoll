...
67. In-progress: E16 distributed scheduler and job reliability parity (step1 claim lease renewal + step2 retry/backoff/DLQ/replay + step3 reliability metrics snapshot API delivered).
