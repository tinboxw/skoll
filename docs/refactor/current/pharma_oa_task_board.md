...
| F10 | `skoll-workflow-jobs` / `skoll-file-storage` | Pharma OA collaboration and compliance | F7, F8, F9 | Announcements, contracts, qualification management, quality complaints, recalls, cold-chain records, compliance dashboard | Qualification expiry, complaints, recalls, and compliance risks are remindable, approvable, traceable, and auditable | Doing |
