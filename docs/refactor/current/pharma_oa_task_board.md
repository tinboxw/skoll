...
| F11 | `skoll-api-contracts` / `skoll-vue-frontend` | Pharma CRM and business dashboard | F8, F9, F10 | Customer follow-up, sales opportunities, payments/invoices, metric API, dashboard widgets, report export | Customer follow-up, sales funnel, stock alerts, qualification expiry, and approval efficiency are visible with correct permissions | Doing |
