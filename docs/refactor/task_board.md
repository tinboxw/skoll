...
| 59 | FE2 | `skoll-frontend-coding-refactor` | 建立前端架构与数据流规范 | API client、Pinia、Router、权限、SchemaForm、错误处理规范 | 前端数据流统一，菜单、路由、按钮、插件权限同源 | `rg "defineStore|beforeEach|SchemaForm|v-permission" web/src` | Doing |
