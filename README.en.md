...
# Optional: explicitly set storage adapter mode (currently available: memory; mysql/postgres are planned)
...
# The unified dashboard includes scheduler_reliability section
...
- E9-step1 persistence adapter rollout design: `docs/planning/E9_STEP1_PERSISTENCE_ADAPTER_ROLLOUT_DESIGN.md`
...
- E9-step1 persistence adapter rollout design record: `docs/milestones/E9-step1-persistence-adapter-rollout-design.md`
